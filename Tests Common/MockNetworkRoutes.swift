...
final class MockNetworkRoutes {
  ...
  fileprivate func mockApiTokenResponse() -> Dictionary<String, Any> {
  ...
  fileprivate func mockVehiclesResponse() -> [Dictionary<String, Any>] {
    return [
      ["vin": "VIN12345",
  ...
  fileprivate func mockCapabilitiesResponse() -> Dictionary<String, Any> {
  ...
  fileprivate func mockEmobilityResponse(mockedResponse: Data) -> Dictionary<String, Any> {
